...
void Room1::init() {
    ...
    effigyModel = rm.loadFBXModel("assets/models/effigy.glb");
    ropeBarrierModel = rm.loadFBXModel("assets/models/rope_barrier.glb");
    coffinModel = rm.loadFBXModel("assets/models/egyptian_coffin.glb");
    mourningFemaleModel = rm.loadFBXModel("assets/models/mourning_female.glb");
    tigerPaintingModel = rm.loadFBXModel("assets/models/tiger_painting.glb");
    painting2Model = rm.loadFBXModel("assets/models/painting2.glb");
    painting3Model = rm.loadFBXModel("assets/models/painting3.glb");
    flashlightModel = rm.loadFBXModel("assets/models/flashlight.glb");
    chandelierModel = rm.loadFBXModel("assets/models/chandlier.glb");
    skirtingBoardModel = rm.loadFBXModel("assets/models/skirtingboard.glb");
    skullModel = rm.loadFBXModel("assets/models/skull.glb");
    spotlightModel = rm.loadFBXModel("assets/models/spotlight.glb");
    lampModel = rm.loadFBXModel("assets/models/lamp.glb");
    statueModel = rm.loadFBXModel("assets/models/statue.glb");
    headModel = rm.loadFBXModel("assets/models/head.glb");
    wallLampModel = rm.loadFBXModel("assets/models/wall_lamp.glb");
