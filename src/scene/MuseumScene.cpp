...
void MuseumScene::init() {
    ...
    // Load Shaders
    shaderProgram = rm.loadShader("mainShader", "assets/shaders/SimpleVertexShader.vertexshader",
                                               "assets/shaders/SimpleFragmentShader.fragmentshader");

    // Load shared textures
    rm.loadTexture("floor", "assets/textures/tiles/tiles_0099_color_1k.jpg");
    rm.loadTexture("wall", "assets/textures/wall/wood_0013_color_1k.jpg");
    rm.loadTexture("bones", "assets/models/bones.png");
    rm.loadTexture("flashlight", "assets/models/Linterna_COLOR.jpg");
    
    // Load shared floor model
    carpetModel = rm.loadModel("assets/models/carpet.obj", true);
    
    // Load flashlight model
    flashlightModel = rm.loadModelWithMaterial("assets/models/Linterna.obj");
