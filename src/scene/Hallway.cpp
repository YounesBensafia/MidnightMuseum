...
void Hallway::init() {
    ...
    displayCabinetModel = rm.loadFBXModel("assets/models/cabinet2.glb");
    smallFossilModel = rm.loadFBXModel("assets/models/small_fossil1.glb");
    smallFossil2Model = rm.loadFBXModel("assets/models/small_fossil2.glb");
